        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-16">
                <div class="bg-white rounded-lg shadow-xl overflow-hidden">
                    {{-- Header --}}
                    <div class="bg-linear-to-r from-amber-600 to-amber-700 p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h2 class="text-3xl font-bold text-white">SEJARAH DESA WARUREJO</h2>
                                <p class="text-amber-100">Jejak Perjalanan dan Perkembangan</p>
                            </div>
                        </div>
                    </div>
                        ...
                        @if($profil->sejarah)
                            <div class="prose prose-lg max-w-none">
                                ...
                                <div class="flex items-start mb-6">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-xl font-bold text-gray-800 mb-4">Awal Mula</h3>
                                    </div>
                                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-purple-500">
                    <div class="flex items-start">
                        <div class="bg-purple-100 rounded-full p-3 mr-4 shrink-0">
                            <svg class="w-8 h-8 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd"/>
                            </svg>
                        </div>
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Warisan Budaya</h3>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Perkembangan</h3>
                            <p class="text-gray-600 text-sm">
            ...
            {{-- Quote Box --}}
            <div class="bg-linear-to-r from-blue-600 to-blue-700 rounded-lg shadow-xl p-8 mb-12 text-white">
                <div class="flex items-start">
                    <svg class="w-12 h-12 text-blue-300 mr-4 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clip-rule="evenodd"/>
                    </svg>
                    <div>
                        <p class="text-xl md:text-2xl leading-relaxed italic mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="{{ route('profil.visi-misi') }}" class="group bg-white rounded-lg shadow-md hover:shadow-xl transition p-6 border-t-4 border-primary-600">
                    <div class="flex items-center">
                        <div class="bg-primary-100 rounded-full p-3 mr-4 group-hover:bg-primary-200 transition">
                            <svg class="w-8 h-8 text-primary-600" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 group-hover:text-primary-600 transition">Visi & Misi</h3>
                            <p class="text-gray-600 text-sm">Lihat visi dan misi desa</p>
                        </div>
                    </div>
                </a>
