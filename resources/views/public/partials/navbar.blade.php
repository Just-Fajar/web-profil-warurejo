    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Desa Warurejo</h1>
                    <p class="text-xs text-gray-600">Kabupaten Madiun</p>
                </div>
            </a>
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <div class="relative group">
                    <button class="text-gray-700 hover:text-primary-600 font-medium transition flex items-center {{ request()->routeIs('profil.*') ? 'text-primary-600' : '' }}">
                        Profil
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        ...
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">RAPBDes</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Alokasi Dana Desa (ADD)</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Dana Desa (DDS)</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Produk Hukum Desa</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Surat Keputusan Kepala Desa</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Alokasi Dana Desa Mandiri</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600">Dana Desa Mandiri</a>
                    </div>
                </div>
            </div>
        ...
        <div x-show="mobileMenuOpen" x-transition class="md:hidden pb-4 bg-white rounded-lg mt-2 shadow-md">
            ...
            <div class="pl-2 mt-2">
                ...
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">RKPDes</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">RAPBDes</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Alokasi Dana Desa (ADD)</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Dana Desa (DDS)</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Produk Hukum Desa</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Surat Keputusan Kepala Desa</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Alokasi Dana Desa Mandiri</a>
                <a href="#" class="block py-2 px-6 text-gray-700 hover:text-primary-600">Dana Desa Mandiri</a>
            </div>
        </div>
    </div>
</nav>
